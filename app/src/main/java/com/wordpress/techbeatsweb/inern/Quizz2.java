...
public class Quizz2 extends Activity {
    private TextView sv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(Quizz2.this,Profile.class);
                startActivity(i);
            }
        });
    ...
    public void q1() {
        if (mQuestionno==6) {
            if (mScore==5) {
                Intent intent = new Intent(Quizz2.this, splash.class);
    ...
    public void updateQuestion() {
        mQuesRef = new Firebase("https://inern-a2bba.firebaseio.com/genral/" + mQuestionno + "/question");
        ...
        bc1ref = new Firebase("https://inern-a2bba.firebaseio.com/genral/" + mQuestionno + "/choice1");
        ...
        bc2ref = new Firebase("https://inern-a2bba.firebaseio.com/genral/" + mQuestionno + "/choice2");
        ...
        bc3ref = new Firebase("https://inern-a2bba.firebaseio.com/genral/" + mQuestionno + "/choice3");
        ...
        bc4ref = new Firebase("https://inern-a2bba.firebaseio.com/genral/" + mQuestionno + "/choice4");
        ...
        mAnsref = new Firebase("https://inern-a2bba.firebaseio.com/genral/" + mQuestionno + "/answer");
        ...
        builder.setPositiveButton("OK",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(Quizz2.this, Profile.class);
                        startActivity(intent);
                    }
                });
        builder.show();
