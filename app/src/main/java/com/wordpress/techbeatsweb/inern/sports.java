...
public class sports extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(sports.this,Profile.class);
                startActivity(i);
            }
        });
    ...
    public void q1() {
        if (mQuestionno==6) {
            if (mScore==5) {
                Intent intent = new Intent(sports.this, splash.class);
    ...
    public void updateQuestion() {
        mQuesRef = new Firebase("https://inern-a2bba.firebaseio.com/sports/" + mQuestionno + "/question");
        ...
        bc1ref = new Firebase("https://inern-a2bba.firebaseio.com/sports/" + mQuestionno + "/choice1");
        ...
        bc2ref = new Firebase("https://inern-a2bba.firebaseio.com/sports/" + mQuestionno + "/choice2");
        ...
        bc3ref = new Firebase("https://inern-a2bba.firebaseio.com/sports/" + mQuestionno + "/choice3");
        ...
        bc4ref = new Firebase("https://inern-a2bba.firebaseio.com/sports/" + mQuestionno + "/choice4");
        ...
        mAnsref = new Firebase("https://inern-a2bba.firebaseio.com/sports/" + mQuestionno + "/answer");
        ...
        builder.setPositiveButton("OK",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(sports.this, Profile.class);
                        startActivity(intent);
                    }
                });
        builder.show();
